...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while distance < self.lower_bound and current_place is not None:
            current_place = current_place.entrance
            distance += 1
        while current_place is not None and not current_place.is_hive:
            bee_to_attack = random_bee(current_place.bees)
            if bee_to_attack:  
                return bee_to_attack    
            current_place = current_place.entrance
            distance += 1
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        reflect_damage = before_health - self.health
    ...
    def action(self, gamestate):
        ...
        while current_place is not None:
            ...
            if (current_place.ant.is_container 
                ...
                and current_place.ant.ant_contained.is_doubled is False):
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self):
        ...
        distance = 0
        while current_place is not None and current_place.is_hive is False:
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 2
        damage = self.damage
        insects_shot = self.insects_shot
        if distance > 0:
            while distance:
                damage -= 0.25
                distance -= 1
