...
def make_let_frame(bindings, env):
    ...
    def collect(bindings):
        ...
        name = binding.first
        val = scheme_eval(binding.rest.first, env, False)
        names_rest, vals_rest = collect(bindings.rest)
        return Pair(name, names_rest), Pair(val, vals_rest)
    names, vals = collect(bindings)
