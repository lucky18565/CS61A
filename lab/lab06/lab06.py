...
class Account:
    ...
    def deposit(self, amount):
        ...
        """
        self.transactions += [Transaction(self.len_id(),self.balance,self.balance + amount)]
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions += [Transaction(self.len_id(),self.balance,self.balance)]
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        aa = make_change(coin,self.coins)
        for x in aa:
